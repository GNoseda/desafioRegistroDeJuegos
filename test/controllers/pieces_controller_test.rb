...
class PiecesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create piece" do
    assert_difference('Piece.count') do
      post pieces_url, params: { piece: { color: @piece.color, name: @piece.name, quantity: @piece.quantity } }
    end
  ...
  test "should update piece" do
    patch piece_url(@piece), params: { piece: { color: @piece.color, name: @piece.name, quantity: @piece.quantity } }
